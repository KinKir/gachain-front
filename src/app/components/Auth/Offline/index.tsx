        ...
        {!props.error && (
            <div style={{ padding: 30 }}>
                ...
                <div className="text-muted">
                    <FormattedMessage id="general.network.notconnected.desc" defaultMessage="Please connect to a network to begin using Gachain. You can manage networks by clicking on the connection indicator in the top right corner of this window" />
                </div>
