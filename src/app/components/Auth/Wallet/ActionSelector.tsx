        ...
        <div>
            ...
            <div className="text-left">
                <Action
                    ...
                    description={<FormattedMessage id="auth.havekey.desc" defaultMessage="If you are already familiar with Gachain and have a backup of your private key, choose this option to guide you through the process of restoring your account data" />}
